# Setup Nexus 3 on Ubuntu using Docker
This guide walks you through installing Docker and setting up a Nexus 3 Repository Manager container on an Ubuntu system.
...
To retrieve the admin password stored inside the Nexus container:
...
# Optional: Manage Nexus Container
- Stop Nexus:
```
docker stop nexus
```
...
docker start nexus
```
- Remove Nexus container (use with caution):
```
docker rm -f nexus
```
