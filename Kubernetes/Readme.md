# ☸️ Set Up Kubernetes Cluster using Kubeadm 

This guide walks you through creating a Kubernetes cluster using `kubeadm`, with **containerd** as the container runtime and **Calico** as the CNI plugin.
